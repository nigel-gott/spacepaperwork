...
class Migration(migrations.Migration):
    ...
    dependencies = [("core", "0024_gooseuser_default_character")]

    operations = [
        migrations.RemoveField(model_name="inventoryitem", name="listed_at_price"),
        migrations.RemoveField(
            model_name="inventoryitem", name="listed_at_price_currency"
        ),
        migrations.RemoveField(model_name="inventoryitem", name="loot_group"),
        migrations.RemoveField(model_name="inventoryitem", name="remaining_quantity"),
        migrations.RemoveField(model_name="inventoryitem", name="total_fees"),
        migrations.RemoveField(model_name="inventoryitem", name="total_fees_currency"),
        migrations.RemoveField(model_name="inventoryitem", name="total_profit"),
        migrations.RemoveField(
            model_name="inventoryitem", name="total_profit_currency"
        ),
        migrations.RemoveField(model_name="inventoryitem", name="transaction_tax"),
