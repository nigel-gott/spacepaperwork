...
urlpatterns = [
    ...
    path('contract/<int:pk>/view', contracts, name='view_contract'),
    path('contract/<int:pk>/reject', contracts, name='reject_contract'),
    path('contract/<int:pk>/accept', contracts, name='accept_contract'),
