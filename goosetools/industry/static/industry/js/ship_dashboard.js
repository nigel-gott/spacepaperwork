    ...
    table = Goose.datatable(function (page_data, table) {
        return {
            ...
            columns: [
                ...
                {
                    "data": "free",
                    "title": "Free (click to change)",
                    "filter_values": ["Free", "Paid For"],
                ...
                {
                    "data": "order_limit_group_name",
                    "title": "Order Limit Group",
                    "defaultContent": "",
                    "give_filter": true
                },
                {
                ...
                {
                    "data": "total_order_quantity_last_month",
                    "title": "Quantity Last Month"
                },
                ...
                {
                    "data": "total_isk_and_eggs_quantity_last_month",
                    "title": "Total Price Last Month",
                    render: function (data) {
                        return data ? Goose.numberWithCommas(data) : ""
                    }
                },
