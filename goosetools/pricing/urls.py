...
from goosetools.pricing.views import pricing_dashboard, PriceListQuerySet, PriceListDetailView, PriceListUpdateView, \
    PriceListDeleteView
...
urlpatterns = [
    ...
    path(
        "dashboard", pricing_dashboard, name="pricing_dashboard"
    ),
    path(
